...
hl.config({
    input = {
        kb_layout = "us,ru",
        kb_options = "grp:ralt_rshift_toggle,caps:swapescape",
        repeat_rate = 66,
        repeat_delay = 350,
        -- tap to click: 1 finger left, 2 right, 3 middle (replaces install/macbook/50-synaptics.conf)
        touchpad = {
            tap_to_click = true,
            tap_button_map = "lrm",
...
-- brightness
hl.bind(mod .. " + F6", hl.dsp.exec_cmd("brightnessctl set 5%-"), { locked = true, repeating = true })
hl.bind(mod .. " + F7", hl.dsp.exec_cmd("brightnessctl set 5%+"), { locked = true, repeating = true })
